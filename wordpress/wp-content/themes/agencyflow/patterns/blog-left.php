...
<h1 class="wp-block-heading has-text-align-center">Blogs</h1>
<!-- /wp:heading --></div></div>
<!-- /wp:cover -->
...
<div class="wp-block-column" style="padding-left:0;flex-basis:33.33%"><!-- wp:template-part {"slug":"sidebar","theme":"agencyflow","area":"uncategorized"} /--></div>
<!-- /wp:column -->
